...
#
TARGET_COMPILER_AR=$(GetCompilerProgName "${AAAAA_TARGET_COMPILER_C}" "ar")
TARGET_MACHINE=$(GetCompilerMachine "${AAAAA_TARGET_COMPILER_C}" )
TARGET_PLATFORM=$(GetCompilerPlatform "${AAAAA_TARGET_COMPILER_C}")
TARGET_ARCH=$(GetCompilerArch "${AAAAA_TARGET_COMPILER_C}")
TARGET_BITWIDE=$(GetCompilerBitWide "${AAAAA_TARGET_COMPILER_C}")
