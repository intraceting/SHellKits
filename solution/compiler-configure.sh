...
cat <<EOF
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_PREFIX=${NATIVE_COMPILER_PREFIX}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_C=${NATIVE_COMPILER_C}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_CXX=${NATIVE_COMPILER_CXX}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_FORTRAN=${NATIVE_COMPILER_FORTRAN}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_SYSROOT=${NATIVE_COMPILER_SYSROOT}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_AR=${NATIVE_COMPILER_AR}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_LD=${NATIVE_COMPILER_LD}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_RANLIB=${NATIVE_COMPILER_RANLIB}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_READELF=${NATIVE_COMPILER_READELF}
export ${SOLUTION_PREFIX}_NATIVE_CMAKE_BIN=${NATIVE_CMAKE_BIN}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_PREFIX=${TARGET_COMPILER_PREFIX}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_C=${TARGET_COMPILER_C}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_CXX=${TARGET_COMPILER_CXX}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_FORTRAN=${TARGET_COMPILER_FORTRAN}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_SYSROOT=${TARGET_COMPILER_SYSROOT}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_AR=${TARGET_COMPILER_AR}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_LD=${TARGET_COMPILER_LD}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_RANLIB=${TARGET_COMPILER_RANLIB}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_READELF=${TARGET_COMPILER_READELF}
export ${SOLUTION_PREFIX}_NATIVE_MACHINE=${NATIVE_MACHINE}
export ${SOLUTION_PREFIX}_TARGET_MACHINE=${TARGET_MACHINE}
export ${SOLUTION_PREFIX}_NATIVE_PLATFORM=${NATIVE_PLATFORM}
export ${SOLUTION_PREFIX}_TARGET_PLATFORM=${TARGET_PLATFORM}
export ${SOLUTION_PREFIX}_NATIVE_ARCH=${NATIVE_ARCH}
export ${SOLUTION_PREFIX}_TARGET_ARCH=${TARGET_ARCH}
export ${SOLUTION_PREFIX}_NATIVE_BITWIDE=${NATIVE_BITWIDE}
export ${SOLUTION_PREFIX}_TARGET_BITWIDE=${TARGET_BITWIDE}
export ${SOLUTION_PREFIX}_NATIVE_COMPILER_VERSION=${NATIVE_COMPILER_VERSION}
export ${SOLUTION_PREFIX}_TARGET_COMPILER_VERSION=${TARGET_COMPILER_VERSION}
export ${SOLUTION_PREFIX}_NATIVE_GLIBC_MAX_VERSION=${NATIVE_GLIBC_MAX_VERSION}
export ${SOLUTION_PREFIX}_TARGET_GLIBC_MAX_VERSION=${TARGET_GLIBC_MAX_VERSION}
EOF
