...
{ 
    if [ ${FLAG} -eq 1 ];then
        exit $(CheckHavePackageFromKit "libffmpeg-nvenc-dev")
    elif [ ${FLAG} -eq 2 ];then
        PackageConfig  --cflags ffnvcodec 
    elif [ ${FLAG} -eq 3 ];then
        PackageConfig  --libs ffnvcodec 
    elif [ ${FLAG} -eq 4 ];then
        echo "libffmpeg-nvenc-dev"
    else
        exit 22
    fi
}
...
{
    if [ ${FLAG} -eq 1 ];then
        exit $(CheckHavePackageFromKit "nv-codec-headers")
    elif [ ${FLAG} -eq 2 ];then
        PackageConfig  --cflags ffnvcodec 
    elif [ ${FLAG} -eq 3 ];then
        PackageConfig  --libs ffnvcodec 
