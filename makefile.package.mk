...
prepare-kit:
	...
	$(MAKE) -C ${MAKEFILE_DIR} INSTALL_PREFIX=${KIT_SYSROOT_TMP}/${INSTALL_PREFIX} install-handy-utils
	$(MAKE) -C ${MAKEFILE_DIR} INSTALL_PREFIX=${KIT_SYSROOT_TMP}/${INSTALL_PREFIX} install-cross-toolchain
	$(MAKE) -C ${MAKEFILE_DIR} INSTALL_PREFIX=${KIT_SYSROOT_TMP}/${INSTALL_PREFIX} install-fast-c-cxx
	$(MAKE) -C ${MAKEFILE_DIR} INSTALL_PREFIX=${KIT_SYSROOT_TMP}/${INSTALL_PREFIX} install-no-trouble-lfs
#
